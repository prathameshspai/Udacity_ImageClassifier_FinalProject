...
parser.add_argument('--lr',type=float, help='Learning Rate, default =0.003',default=0.003)
parser.add_argument('--hidden_units',type=int, help='Hidden Units, default = 500',default=1000)
